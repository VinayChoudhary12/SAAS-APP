    ...
    <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        <div className="md:max-w-96">
            ...
            <p className="mt-6 text-sm">
                Experience the power of AI with QuickAi.<br></br>Transform content creation
                with our suite of premium AI tools.Write article,generate images,and enhance your workflow.
            </p>
        </div>
